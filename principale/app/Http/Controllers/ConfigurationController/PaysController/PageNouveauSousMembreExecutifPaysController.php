...
class PageNouveauSousMembreExecutifPaysController extends Controller
{
    //
    public function index(Request $request): RedirectResponse|View
    {
        ...
        return view('principale.pays.nouveauSousMembreExecutifPays', compact('UtilisateurConnecter', 'SousExecutifExist', 'PaysPris', 'InterfacePaysRecuperer', 'sousMembreExecutifPays', 'nombreSousMembreExecutifPays'));
