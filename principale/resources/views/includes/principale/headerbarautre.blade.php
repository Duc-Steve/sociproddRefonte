            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-sociprodd-bleuefoncee px-4 px-lg-5 py-2 py-lg-0">
                <!-- Bouton de Menu -->
                <div class="menu-toggle align-items-center d-flex gap-3 me-4">
                    ...
                    <!-- Pour Téléphone -->
                    <span class="text-sociprodd-bleuefoncee d-block d-lg-none">Menu</span>
