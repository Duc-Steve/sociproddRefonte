...
@section('optimisation')
    ...
    <!-- Titre de la page -->
    <title>SOCIPRODD - {{Crypt::decrypt($PaysDonnee->nom_normale)}} (Reportages)</title>

    <!-- Description de la page pour les moteurs de recherche -->
    <meta name="description" content="Page des reportages de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />

    <!-- Balises Open Graph pour Facebook et autres réseaux sociaux -->
    <meta property="og:title" content="SOCIPRODD - {{Crypt::decrypt($PaysDonnee->nom_normale)}} (Reportages)" />
    <meta property="og:description" content="Page des reportages de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />
    ...
    <meta name="twitter:description" content="Page des reportages de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="page-title">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('pays-reportages', ['PaysUrl' => $PaysDonnee->nom_url]) }}">nos reportages</a>
    ...
    @if($NombreReportagesActifs)
        <!-- Reportage -->
        <section id="page-content">
            <div id="NosReportages" class="container">
                <div class="row">

                @foreach($ReportagesActifs as $ReportagesActifsIndividu)
                    <div class="col-lg-4 mt-3">
                        <div class="br-sociprodd-1 bdr-sociprodd-all-bleuefoncee p-3">
                            <div class="ratio ratio-16x9">
                                <iframe src="{{ Crypt::decrypt($ReportagesActifsIndividu->lien_video) }}" allowfullscreen style="border-radius: 5px;"></iframe>
                            </div>
				...
				<div class="row vh-100">
					<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
						<div class="d-table-cell align-middle">
                            ...
                            <h2>Il n'ya pas de reportage pour vous ! </h2>
            	        </div>
					</div>
				</div>
            </div>
