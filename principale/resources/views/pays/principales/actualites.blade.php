...
@section('optimisation')
    ...
    <!-- Titre de la page -->
    <title>SOCIPRODD - {{Crypt::decrypt($PaysDonnee->nom_normale)}} (Actualités)</title>

    <!-- Description de la page pour les moteurs de recherche -->
    <meta name="description" content="Page des actualités de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />

    <!-- Balises Open Graph pour Facebook et autres réseaux sociaux -->
    <meta property="og:title" content="SOCIPRODD - {{Crypt::decrypt($PaysDonnee->nom_normale)}} (Actualites)" />
    <meta property="og:description" content="Page des actualités de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />
    ...
    <meta name="twitter:description" content="Page des actualités de la SOCIPRODD {{Crypt::decrypt($PaysDonnee->nom_normale)}}" />
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="page-title">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('pays-actualites', ['PaysUrl' => $PaysDonnee->nom_url]) }}">nos actualités</a>
    ...
    @if($NombreActualitesActifs > 0)
        <!-- Actualites -->
        <section id="page-content">
            <div id="NosActualitess" class="container">
                <div class="row">

                @foreach($ActualitesActifs as $ActualitesActifsIndividu)
                        ...
                        <div class="br-sociprodd-1 bdr-sociprodd-all-bleuefoncee p-3">
                            ...
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    ...
                                    @if(Crypt::decrypt($ActualitesActifsIndividu->lien_video) != null)
                                        <div class="post-video">
                                            <iframe class="br-sociprodd-1" width="560" height="315" src="{{Crypt::decrypt($ActualitesActifsIndividu->lien_video)}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        </div>
                                    @else
                                        <div class="post-image">
                                            <a href="{{ route('information', ['PaysUrl' => $PaysDonnee->nom_url, 'IdElementSite' => $ActualitesActifsIndividu->id_element]) }}">
                                                <img alt="" src="{{ config('images-basiques-paths.basique') }}/{{Crypt::decrypt($ActualitesActifsIndividu->lien_photos)}}">
                                            </a>    
                                            <span class="post-meta-category">Actualité</span>
                                                    
                                        </div>
                                    @endif
                                    
                                    <div class="post-item-description">
                                        <span class="post-meta-date">{{ $ActualitesActifsIndividu->created_at->format('Y-m-d')}}</span>
                                        <h2><strong style="margin-top: 1em">{{ Crypt::decrypt($ActualitesActifsIndividu->titre) }}</strong></a> </h2>
                                        <p>{{ Crypt::decrypt($ActualitesActifsIndividu->petite_description) }}</p>
                                        <a href="{{ route('information', ['PaysUrl' => $PaysDonnee->nom_url, 'IdElementSite' => $ActualitesActifsIndividu->id_element]) }}" class="item-link bg-sociprodd-jaune p-1 px-3"><strong class="text-sociprodd-bleuefoncee">Lire plus 
				...
				<div class="row vh-100">
					<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
						<div class="d-table-cell align-middle">
                            ...
                            <h2>Il n'ya pas d'actualités pour vous ! </h2>
            	        </div>
					</div>
				</div>
            </div>
