                        ...
                        <div class="col-lg-3 mt-3">
                            <div class="card-body d-flex justify-content-center br-sociprodd-1 bg-sociprodd-bleuefoncee p-3 py-5">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="col mt-0 d-flex flex-column gap-2">
                                        <strong class="text-sociprodd-blanc" style="font-size: 16px;">Utilisateurs</strong>
                                        <h1 class="text-sociprodd-blanc">{{$NombreUtilisateur}}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mt-3">
                            <div class="card-body d-flex justify-content-center br-sociprodd-1 bg-sociprodd-bleuefoncee p-3 py-5">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="col mt-0 d-flex flex-column gap-2">
                                        <strong class="text-sociprodd-blanc" style="font-size: 16px;">Membres</strong>
                                        <h1 class="text-sociprodd-blanc">0</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
